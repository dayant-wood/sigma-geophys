...
$title = "New message to LLC SIGMA";
$body = "
<h2>New appeal</h2>
<b>Name:</b> $name<br>
...
try {
    ...
    $mail->SMTPSecure = 'ssl';
    $mail->Port       = 465;
    $mail->setFrom('diana.galieva1992@mail.ru', 'LLC SIGMA'); // Адрес самой почты и имя отправителя

    // Получатель письма
    $mail->addAddress('info@sigma-geophys.com');  
